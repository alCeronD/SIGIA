...
VALUES (
    ...
    (
        ...
        '0000-00-00',
        'LLEVAR LA PLATINA',
        'FALTA TORINILLO PARA LA PLATINA',
        4,
        1,
        1,
        6,
    ...
    (
        ...
        1,
        '0000-00-00',
        'REVISAR MALETIN CON CARGADOR Y LLEVAR TRIPODE DE LUZ',
        'FALTA MARIPOSA - FALTA CABLE DE PODER',
        4,
        1,
        1,
        5,
    ...
    (
        ...
        '0000-00-00',
        'REVISAR MALETIN CON CARGADOR Y LLEVAR TRIPODE DE LUZ',
        'FALTAN 5 BOMBILLOS - FALTA MANILA',
        4,
        1,
        1,
        5,
    ...
    (
        ...
        1,
        '0000-00-00',
        'LLEVAR TRIPODE DE LUZ CÁLIDA Y CABLE DE PODER',
        'COMPLETA',
        4,
        1,
        1,
    ...
    (
        ...
        1,
        '0000-00-00',
        'LLEVAR CABLE DE PODER Y TRIPODE DE LUZ',
        'COMPLETA',
        4,
        1,
        1,
    ...
    (
        ...
        100189107,
        '100189107',
        'CÁMARA VIDEO PANASONIC (HANDICAM)',
        1,
        '0000-00-00',
        'RECUERDE LLEVAR SD ',
        'DEVOLUCION',
...
VALUES (
    ...
    (
        ...
        1,
        '2025-08-27 04:38:02',
        'valido con el data codigo null.',
        6,
        172,
        1,
        665
    ...
    (
        ...
        1,
        '2025-08-28 14:43:23',
        'Se da salida a este proceso de elementos.',
        2,
        109,
        23,
        715
...
INSERT INTO
    `estados_usuarios` (`est_id`, `est_nombre`)
VALUES (1, 'Activo'),
    (2, 'Inactivo');
...
VALUES (
    ...
    (
        ...
        'Generar Reporte Entrada Salida',
        4,
        2
    ),
    (
        66,
        'generarReportePorPlaca',
        'Generar Reporte Elementos',
        4,
        2
    ),
    (
    ...
    (
        105,
        'executeCancelPrestamo',
        'Cancelar Prestamo (Acción)',
        5,
        2
    );
...
VALUES (
    ...
    (
        12,
        'Aprendiz',
        'Solo puede acceder a este bloque.',
        1
    ),
    (
        16,
        'Coordinador',
        'prueba del rol coordinador.',
        1
    ),
    (
        20,
        'Pruebas',
        'Rol de prueba para comprender el comportamiento de los modulos según su caso.',
        1
    );
...
VALUES (
        1,
        'Render',
        'Funcion de tipo renderizado que permite renderizar'
    ),
    (
        2,
        'Logica',
        'Función de tipo lógica, no muestra ninguna vista.'
    );
...
VALUES (
        1,
        'Deposito',
        'Tipo de movimiento en el cual se agrega una existencia adicional al elemento'
    ),
    (2, 'Salida', NULL),
    ...
    (
        5,
        'Regresión',
        'tipo de movimiento que permite devolver aquellas existencias.'
    ),
    (
        6,
        'Cancelado',
        'Reserva cancelada por el usuario asignado, no se dio salida a la reserva'
    );
...
INSERT INTO
    `tipo_prestamo` (`tp_pre`, `tp_nombre`)
VALUES (1, 'Reserva Inmediata'),
    (2, 'Reserva Previa');
...
VALUES (
        1,
        'Unidad',
        'Clasificado como undidad de elemento.'
    ),
    (
        2,
        'Caja',
        'Elementos que dentro de su caja contienen las respectivas unidades.'
    ),
    (3, 'Galon', ''),
    (4, 'No aplica', '');
...
VALUES (
        ...
        'Jhon',
        'doe nuevo',
        '$2y$10$lqtlzfSwmgBii6QKERQjk.Q0pDEZ3E47UehNQQiacUJKHOkRMle0q',
        'jhondoe@gmail.com',
        'Calle 2',
        '4444122',
        NULL,
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$T.fGRHivXg7ytOibxiSMyOGvB3rvQ6Nq4z2IiWuilXYFZCJSe6Fwm',
    ...
    (
        ...
        'Alejandro',
        'Rojas',
        '$2y$10$lWp9fMFDtlLl3MDI.IDApuIPJTPRSGlOV8WUMOt4TeqIVffVfdFQ.',
        'rjAlejandrocd@gmail.com',
        'Av 32 N # 83 - 103',
        '3000000003',
        NULL,
        1,
    ...
    (
        ...
        'Valentina',
        'Cortés',
        '$2y$10$tlqIP2iHW4mtaddKPm9z/OwnJwTF.rWSkVbvejn0IAjtdzPgisENa',
        'valentina.cortes@example.com',
        'Calle 18',
        '3000000018',
        NULL,
        1,
    ...
    (
        ...
        'Gabriel',
        'Vargas',
        '$2y$10$fJWee3EyFDrZ0U.xVhEdZ.dtu0TNdB8u1l6lbOUw2jl05WYSk/pTm',
        'gabriel.vargas@example.com',
        'Calle 27',
        '3000000027',
        NULL,
        1,
    ...
    (
        ...
        'Jimena',
        'Lopez Pumarejo',
        '$2y$10$pQItJaHSTByqDBAHGrIl/uid7gMl6wPMWcBjXR8eIZnzYhpVNg20W',
        'jimena.lopez@gmail.com',
        'Calle 93 B # 13-03',
        '3000005230',
        NULL,
        1,
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$zZDMorvOwpCJH5D6VvMb6ORv6IePjNCom6D3Prsq9pF57bR9eqr5i',
        '2_1@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        NULL,
        1,
        3
    ...
    (
        ...
        'alejandro',
        'Pérez',
        '$2y$10$Kbs/gKo1R2DqeI/HL8N5Du8qIrcJYfkTdPiHrJK8iA8ZMsCP0SaoS',
        'juan.perez@example.com',
        'calle 2 d oeste # 74 e 02',
        '3000000001',
        NULL,
    ...
    (
        ...
        'dasdasd',
        'ceron',
        '$2y$10$xo.C3p25NfRxVyEf.HUbleet/pF.3R23vX0X9KVLBiiXgaAUUemoK',
        '3_2@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        NULL,
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$GO3TlYxTUJgVnIXNYDqTiu.Homl29S7YcuErpTKlIeU1z53W17RBG',
        '2_3@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        NULL,
    ...
    (
        ...
        'Edward',
        'Fernandez',
        '$2y$10$/tXlxO3K4WQieMTze0gcAuQXfFsSBSs89JOuAtAVzwCfFN7T8Qese',
        'edwardFer@gmail.com',
        'Calle 93 B # 13-03',
        '5536735',
        NULL,
    ...
    (
        ...
        'Faker',
        'Human',
        '$2y$10$HnjmFwEfXqtQZaC3vzBo3..vTN73qtuvLi.WFvj.DMRV9UKwYAPXS',
        '5_4@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '44345345',
        NULL,
    ...
    (
        ...
        'Eric',
        'Carman',
        '$2y$10$FCZPGmrhUeb2z5CmCfP5fO0vcwFJPzrx5OmUTZsz3zpK4M2suviFu',
        'carman@gmail.com',
        'Calle 93 B # 13-03',
        '53455432452',
        NULL,
    ...
    (
        ...
        'patricia',
        'gonzales',
        '$2y$10$YaMgoRG8a59lMgSYmhUwde8Dj5gKf.58RjMnGGPoI3geuy4H/CHEC',
        'patric@gmail.com',
        'Calle 93 B # 13-03',
        '53455432452',
        NULL,
    ...
    (
        ...
        'Alexander',
        'gonzales',
        '$2y$10$WLJU12ALtQbJGFxirSNGaOJqCMew9wyCROomd2DHoHfLgVnv4copG',
        'alex_g@gmail.com',
        'Calle 93 B # 13-03',
        '53455432452',
        NULL,
    ...
    (
        ...
        'Fernando',
        'uticaria',
        '$2y$10$QksEBkNcAK15ktSZSdMnSuvHHsLaINCRwGaRiMuhRQfwHxde2fcUK',
        'fernandoutil@gmail.com',
        'Calle 93 B # 13-03',
        '5234234',
        NULL,
        1,
    ...
    (
        ...
        'Diana marcela',
        'Gutierrez',
        '$2y$10$ySel.GVOu2vEbiqYu13.BeCAZXt64QluXfXPKtwbvMTrYY4EoTqqO',
        'marceD@gmail.com',
        'Calle #4 - 32 -23',
        '34056738',
        NULL,
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$G4ofjuHI5hKeCzTc1bPa5uyJyPwRURHfo6VAwFHZaD1Rrw7ofj0sy',
        'maria.Lopez32@gmail.com',
        'Calle 2',
        '3000000002',
        NULL,
        1,
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$a3t1Scz9gQCMxTfxAWo2fu./YV1QvUzcIyEaKAL9QDpjSQq5kqgH2',
        'hello@gmail.com',
        'Calle 2',
        '3000000002',
        '',
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$QS92GIOg4MIi2c8649SDPeALoKcL0pjK8agxV0Wv3mdB.yQ5qKXju',
        'hello@gmail.com',
        'Calle 2',
        '3000000002',
        '',
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$XXqBDZ/eti1NqtBnIoy7QuM.5Pu8ZJw0JQFPQiPMW0nLhdEaeWvjC',
        'hello@gmail.com',
        'Calle 2',
        '3000000002',
        'sdfsdf',
    ...
    (
        ...
        'María',
        'López',
        '$2y$10$Nuos/m5VHOaP4rT7wVDQ1uoP2icgUgjIkESoE7I6uc28wdVRgDVim',
        'helloWorldPrueba@gmail.com',
        'Calle 2',
        '3000000002',
        ' prueba nueva enviando el usuariio.',
        1,
        2
    ),
    (
        ...
        'María',
        'López',
        '$2y$10$HQeEWgvHLL2gEdkPf0eJoOWqn7DXwLRQctnRZjg3cl4/OgovU3irW',
        'helloMaria@gmail.com',
        'Calle 2',
        '3000000002',
        'aaaa',
        1,
    ...
    (
        ...
        'Mariana',
        'Rivera',
        '$2y$10$0cug9rbOUYj4ivTPEh1ip.X0FxYNXDLfbGhM5Z4F9HrDDH8zQAoBK',
        'mr.rivera@gmail.com',
        'Calle 2',
        '3000000002',
        ' prueba nueva enviando el usuariio.',
    ...
    (
        ...
        'Isabella',
        'Rivera',
        '$2y$10$liKvL0n4zDBXHd1c9U1uR.afJu1EdG0yix2jh.vV1P5J65bivCYxO',
        'hello@gmail.com',
        'Calle 2',
        '3000000002',
        'Solicito nuevo usuario.',
        1,
        4
    ),
    (
        ...
        'Isabella',
        'Rivera',
        '$2y$10$g8zveEh4fHUpE60A46YrO.nzVsc.0jcIJeDAGuySjBwLv3Zq6YMmy',
        'hello@gmail.com',
        'Calle 2',
        '3000000002',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$6N3vmSHd7fgub1YBdHLk6urmGfjK4EsIr0iZQ5IQkgE8BmPtk8GFq',
        '4_5@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        'hola mundo',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$94XiXQaiJnh753Rw.IwIfOB5llWPRxdYLbtWNh6mQlbtQ9sS3NURW',
        '4_6@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        '',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$7bNsFRSivJgEVGv7pOFwuejdP/XQDj7CVxxQRAv6Lu4TJVNZMAT36',
        '4_7@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        '',
    ...
    (
        ...
        'alejandro',
        'ceron d',
        '$2y$10$K0XKfn2Lc/lKNP7R4NcOSOmCvDxfu7yRj205Bou4/dUTvdBGmvsOy',
        'lalejandrcd1@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322443',
        'dd',
        2,
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$L0u4YSSLqaLF/4./yuBznOFIS.UjtCtjeqWYRpWAd1GYMuS3vM.la',
        '2_9@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        '',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$hPtw.4P20KAWdwBwPQzrGuOElrYBVfz3dSliIaQjOC0X/GDpSdVAK',
        '1_10@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        'asdasdasd',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$1IVNZDufxJoTBITCyZundO5vE/If0TTA2ZN8rqzP4sJ1Rt7IW5bvS',
        '1_11@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        '',
    ...
    (
        ...
        'alejandro',
        'ceron ocoro',
        '$2y$10$HPHJ9MUV9GCaAxuMzm5qAuVqg0hnJf4cgZjHnzSPIhJBrsRP3c/ni',
        '4_12@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        'asddd',
    ...
    (
        ...
        'alejandro',
        'ceron',
        '$2y$10$xdqXglY9B85CBc6ah43PaOfDLoGFmOUe.1CFCfpPrzKRpQm3uTtni',
        '3_13@gmail.com',
        'calle 2 d oeste # 74 e 02',
        '3322',
        'ddd',
    ...
    (
        ...
        'jhon doe',
        'pro',
        '$2y$10$fZr14Dw3Q3Hfii/1yRZkVO9p.QakhNbOkb7NV3WWp6GtsahvXArKG',
        '1_14@gmail.com',
        'Calle 5',
        '3000000005',
        '',
    ...
    (
        ...
        'paola',
        'gris',
        '$2y$10$mD7tGTXzVZpOGwgvttjlv.lO33nmpFqUjgr47QeOfp31y8Hgtuiry',
        'paola.gris@gmail.com',
        'Calle 9 # 32 - 12',
        '3000000005',
        'ddd',
        1,
    ...
    (
        ...
        'Diana Patricia',
        'Gonzales P',
        '$2y$10$JObXt4vaTkGWX2b0cnF90u.TusZNOLAb0PJ6yGBC.142/L0XerA9i',
        'diana.Patricia@soysena.edu.co',
        'Calle 9 # 32 - 12',
        '3646743918',
        '',
        1,
    ...
    (
        ...
        'Alejandro',
        'Rojas',
        '$2y$10$ZJulVCW8adsxSLKWkA7FxOtO5e9OmEY85VaOFK8fnSi0RQYcAF4im',
        'rjdddd@gmail.com',
        'Av 32 N # 83 - 103',
        '3000000003',
        'hola mundo',
    ...
    (
        ...
        'Alejandro',
        'Rojas',
        '$2y$10$aQ1cnxj15GKRy58vZrP5B.tIvTmeARXLSVbqPP0ti/BCuE1gA1kB2',
        'rjAocd@gmail.com',
        'Av 32 N # 83 - 103',
        '3000000003',
        'información adicional',
    ...
    (
        ...
        'Alejandro',
        'Rojas',
        '$2y$10$1b1u8jpkG5TvArDRykIF8u9EbNoQ6pAVbyTZBlCJgNvH2EMWTa1ni',
        'rjrojasaprendiz@gmail.com',
        'Av 32 N # 83 - 103',
        '3000000003',
        'hola mundo.',
        1,
    ...
    (
        ...
        'Ana Liliana',
        'Fernández',
        '$2y$10$0WFTjjeeOkPN07QeoX.U3eP42tG20BUMuNKbwv4ACqALRbO7KpMGm',
        'ALANA@gmail.com',
        'Calle 6 # 344 - 32',
        '3000000006',
        'DDDDD',
    ...
    (
        ...
        'Fernando Collazos',
        'Oliveria',
        '$2y$10$m9rm/rHBXkIGNMljTahnD.6cH0/gl6TE1ErjhSCrpJ7sT5FLwO2Xq',
        'fernandoOlv@gmail.com',
        'Av 32 N # 83 - 103',
        '4123123213',
        'Es el usuario coordinador de la central didáctica.',
        1,
        1
    ),
    (
        ...
        'Adddro',
        'Rojas',
        '$2y$10$nQl07mG65UqEl3OAm7xxtegzVxsh.vGiRJZbdq/OY13sf8IhPl6US',
        'rjAaddro332d@gmail.com',
        'Av 32 N # 83 - 103',
        '3000000003',
        'usuario de prueba.',
        1,
    ...
    (
        ...
        'Alax',
        'Brahim ',
        '$2y$10$43ijWw2hW9kl22KUzYSU9e3A52T9Z2RsHpkLkM1hD7EN6qF9pktgC',
        'brahiamApex@gmail.com',
        'Av 32 N # 9 - 11',
        '30000355',
        'Es musulman, pd: explota.',
        1,
        3
    );
...
--
ALTER TABLE `estados_elementos` ADD PRIMARY KEY (`est_el_cod`);

--
-- Indices de la tabla `estados_prestamos`
--
ALTER TABLE `estados_prestamos` ADD PRIMARY KEY (`es_pr_cod`);

--
-- Indices de la tabla `estados_usuarios`
--
ALTER TABLE `estados_usuarios` ADD PRIMARY KEY (`est_id`);
...
--
ALTER TABLE `permisos` ADD PRIMARY KEY (`per_id`);
...
--
ALTER TABLE `roles` ADD PRIMARY KEY (`rl_id`);
...
--
ALTER TABLE `tipo_elemento` ADD PRIMARY KEY (`tp_el_cod`);

--
-- Indices de la tabla `tipo_funcion`
--
ALTER TABLE `tipo_funcion` ADD PRIMARY KEY (`id_tp_funcion`);

--
-- Indices de la tabla `tipo_movimiento`
--
ALTER TABLE `tipo_movimiento` ADD PRIMARY KEY (`cod_tp`);

--
-- Indices de la tabla `tipo_prestamo`
--
ALTER TABLE `tipo_prestamo` ADD PRIMARY KEY (`tp_pre`);

--
-- Indices de la tabla `tipo_unidad`
--
ALTER TABLE `tipo_unidad` ADD PRIMARY KEY (`cod_tp_uni`);
...
--
ALTER TABLE `compras`
MODIFY `cod_compra` int(11) NOT NULL AUTO_INCREMENT COMMENT 'codigo autoincrementable identificador de la existencia',
AUTO_INCREMENT = 52;
...
--
ALTER TABLE `elementos`
MODIFY `elm_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'codigo primario autoincrementable',
AUTO_INCREMENT = 153;
...
--
ALTER TABLE `entradas_salidas`
MODIFY `ent_sal_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único de la entrada o salida',
AUTO_INCREMENT = 410;
...
MODIFY `est_el_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único del estado del elemento',
AUTO_INCREMENT = 6;
...
MODIFY `es_pr_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único del estado del préstamo',
AUTO_INCREMENT = 7;
...
MODIFY `est_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único del estado del usuario',
AUTO_INCREMENT = 4;
...
--
ALTER TABLE `funciones`
MODIFY `id_funcion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id representativo primario de la tabla funciones',
AUTO_INCREMENT = 106;
...
MODIFY `per_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del permiso',
AUTO_INCREMENT = 5;
...
--
ALTER TABLE `prestamos`
MODIFY `pres_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código identificador del préstamo',
AUTO_INCREMENT = 721;
...
--
ALTER TABLE `prestamos_elementos`
MODIFY `pres_el_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único del registro de préstamo de elemento',
AUTO_INCREMENT = 2018;
...
--
ALTER TABLE `roles`
MODIFY `rl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del rol',
AUTO_INCREMENT = 22;
...
MODIFY `tp_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del tipo de documento',
AUTO_INCREMENT = 32;
...
MODIFY `tp_el_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del tipo de elemento',
AUTO_INCREMENT = 3;
...
MODIFY `id_tp_funcion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Valor auto increment del tipo de función',
AUTO_INCREMENT = 3;
...
MODIFY `tp_pre` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del tipo de prestamo',
AUTO_INCREMENT = 3;
...
MODIFY `cod_tp_uni` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único de la unidad de medida',
AUTO_INCREMENT = 5;
...
--
ALTER TABLE `usuarios_roles`
MODIFY `usr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código único de la relación usuario-rol ​:contentReference[oaicite:0]{index=0}​',
AUTO_INCREMENT = 1205;
