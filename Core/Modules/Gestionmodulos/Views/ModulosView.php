      ...
      <div class="card z-depth-2">
        <div class="card-content">
          ...
          <form id="formModuloCreate" class="formLayout">
            ...
            <div class="input-field contentRoute">
              <span>Ruta de acceso</span>
              <input type="text" name="modulo" id="modulo" class="validate" placeholder="Modulo">
              <input type="text" name="controlador" id="controlador" class="validate" placeholder="Controlador">
              <input type="text" name="funcion" id="funcion" class="validate" placeholder="Funcion">
            </div>
