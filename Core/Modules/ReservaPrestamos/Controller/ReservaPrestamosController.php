...
class ReservaPrestamosController
{
    ...
    private ElementosModel $modelElemento;
    ...
    public function getElementosConsumibles(int $pages = 1, int $type = 2)
    {
        ...
        Response::success('elementos consumibles', $data);
    }
    ...
    public function getUsers($page)
    {
        ...
        if ($data != null) {
            Response::success('Usuarios activos', $data);
        }
    }
    ...
    public function getReservas(int $pages = 0, String $type = '')
    {
        ...
        if (!$pages) {
            Response::fail('pagina no definida');
        }
    ...
    public function getElementsReserva($codigo)
    {
        ...
        Response::success('Elementos relacionados al codigo', $dataDetail);
    }
    ...
    public function setSolicitud(array $data = [])
    {
        ...
        if (!$result) {
            Response::fail('error al validar el prestamo');
        }
        Response::success('prestamo validado');
    }
    ...
    public function setEndReserva(array $elementos = [], int $codigo = 0, array $data = [])
    {
        ...
        if ($data['status']) {
            Response::success('Prestamo finalizado.');
        }
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        switch ($case) {
            ...
            case 'validateElement':
                ...
                $fechaReservaUser = empty($_GET['fechaReserva']) ? "" : $_GET['fechaReserva'];
                $fechaDevolucionUser = empty($_GET['fechaDevolucion']) ? "" : $_GET['fechaDevolucion'];
