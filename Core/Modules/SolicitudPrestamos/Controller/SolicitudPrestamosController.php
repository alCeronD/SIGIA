...
class SolicitudPrestamosController
{
    ...
    public function consultarPrestamosView()
    {
        ...
        $prestamoModel = new SolicitudPrestamosModel($this->conn);
    ...
    public function registrarPrestamo(array $data = [])
    {
        ...
        try {
            ...
            $objSolicitud = new SolicitudPrestamosModel($this->conn);
    ...
    public function verDetallePrestamo(int $presCod)
    {
        if (!$presCod || !is_numeric($presCod)) {
            Response::fail('Id no valido');
            return;
        }

        $modelo = new SolicitudPrestamosModel($this->conn);
        $detalle = $modelo->searchU($presCod);
        if (!$detalle) {
            Response::fail('No se encontró información del préstamo');
        }
        ...
        Response::success('Detalle del prestamo', $detalle);
    }
    ...
    public function validarSocPrestamo(array $data = []) {
        ...
        try {
            ...
            $model = new SolicitudPrestamosModel($this->conn);
