...
const modalCategoria = instanceModal('#modalEditarCategoria',{"inDuration":options.inDuration, "outDuration": options.outDuration, "opacity":options.opacity});
...
td.forEach((itemTd)=>{
  itemTd = (itemTd.textContent === 'Activo') ? itemTd.style.color = 'green' :itemTd.style.color = 'red';
});
